...
<div class="row">
  ...
  <div class="col-md-6">
	<div class="well well-sm">
    	<div class="row">
  			<div class="col-md-4">매장 레벨 : 1</div>
	...
	<div class="panel panel-default">
      ...
      <div class="panel-heading" align="center">효과</div>
      <div class="panel-body">
        <p class="text-center">효과없음<br />
        "셰프의 낡은 식칼"로 인하여 요리의 질이 1% 상승 하였습니다.</p>
      </div>
   </div>
	<div class="row">
		<div class="col-md-6">
			<div class="panel panel-default" align="center">
                <div class="panel-body">
                    <img src="./images/kitchen.png" class="img-responsive">
                </div>
            </div>
		</div>
		...
		<div class="col-md-5">
			<div class="panel panel-default">
				<div class="panel-body" align="center">
					<img src="./images/guest1.png" class="img-responsive">
				</div>
			</div>
		</div>
    </div>
                ...
                <!-- 인터페이스 부분 -->
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="panel-body">
							<div class="panel panel-default">
								...
								<h3 class="panel-title">재료선택</h3>
							</div>
							<div class="panel-body">
                            <span class="label label-default">당근</span><span class="label label-default">오이</span><span class="label label-default">상추</span><span class="label label-default">양배추</span>
							</div>
						</div>
                        </div>
                      ...
                      <div class="panel-body">
							<div class="panel panel-default">
								<div class="panel-heading">
								<h3 class="panel-title">레시피 순서</h3>
							</div>
							<div class="panel-body">
								<ul class="pagination">
                                  <li><a href="#">«</a></li>
                                ...
                                <select multiple class="form-control">
                                  <option>1번+2번 값</option>
                                  <option>2</option>
                                  <option>3</option>
                                  <option>4</option>
                                  <option>5</option>
                                </select>
                                <button type="submit" class="btn btn-default">요리 내놓기</button>
                                </form>
		...
		<div class="col-md-5">
			<div class="panel panel-default">
				<div class="panel-body">
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h3 class="panel-title">여기 주문이요!</h3>
                      </div>
                      <div class="panel-body">
                        <h4><p class="text-warning">음식 : 간짜장</p></h4><br /><p>제가 원하는 음식은 (간짜장) 이지만 남들과는 다른 간짜장을 먹고 싶어요. 어떤 간짜장을 저에게 해주실 수 있는지 지켜보겠어요!</p>
                      </div>
                    </div>
				</div>
			</div>
